...
func (s *MariaS2sLoginService) GetUserScopes(uuid string) ([]session.Scope, error) {
...
func (s *MariaS2sLoginService) PersistRefresh(r session.Refresh) error {
...
func BuildAudiences(scopes []session.Scope) (unique []string) {
...
func (s *MariaS2sLoginService) GetRefreshToken(refreshToken string) (*session.Refresh, error) {
...
func NewS2sLoginHandler(service session.LoginService) *S2sLoginHandler {
